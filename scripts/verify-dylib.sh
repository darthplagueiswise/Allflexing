...
require_text "plain semantic mode selector" "runtimeBrowserShouldUsePlainTextSearchForQuery:" "$string_dump"
require_text "plain semantic bridge selector" "runtimeBrowserSearchPlainTextQuery:completion:" "$string_dump"
require_text "search grammar help selector" "showRuntimeSearchHelp:" "$string_dump"
