...
- (FLEXHookEntry *)af_runtimeSnapshot_upsertDiscoveredEntry:(FLEXHookEntry *)entry {
    ...
    // A complete image can expose tens of thousands of methods/functions.
    // The active browser snapshot owns them; keeping them transient avoids one
    // registry notification and persistence write per row during a scan.
